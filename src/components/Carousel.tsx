...
function Carousel() {
  ...
  return (
    <div
      ...
      data-carousel="slide"
    >
      <div className="relative h-56 overflow-hidden transform transition-transform rounded-base md:h-96">
        {/* <!-- Item 1 --> */}
        <div
          className="  duration-700 transform transition-transform ease-in-out"
          data-carousel-item="active"
        >
          <img
            src={item1}
            className="absolute  block w-full transform transition-transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
          ></img>
        </div>
        {/* <!-- Item 2 --> */}
        <div
          className="  hidden duration-700 transform transition-transform ease-in-out"
          data-carousel-item
        >
          <img
            src={item2}

        ...
        <div className="flex h-20 items-center  justify-items-center  place-content-around">
          ...
          <div className="hidden md:block md:flex-1 md:mx-4 ">
            <input
              ...
              className=" w-full 2xl:w-160 xl:w-100 p-2 border border-gray-600 shadow-md bg-gray-300  rounded-lg flex flex-nowrap focus:outline-none focus:ring focus:ring-indigo-100"
            />
          </div>
          {/* Menú + Carrito */}
